        ...
        <div className="bg-surface-accent/30 p-8 rounded-2xl border border-border-color">
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {getSkills(['React', 'Angular', 'VueJS', 'Next.js', 'JQuery', 'Redux', 'Styled Components']).map(skill => (
                  <span key={skill.id} className="skill-tag">{skill.name}</span>
                ))}
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {getSkills(['Mobile First', 'CSS Grid', 'Flexbox', 'Media Queries', 'Material UI', 'Bootstrap', 'SASS', 'LESS', 'CSS Modules', 'Figma', 'Tailwind CSS']).map(skill => (
                  <span key={skill.id} className="skill-tag">{skill.name}</span>
                ))}
              </div>
            </div>
